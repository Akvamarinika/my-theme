...
<section class="main__section">
    ...
    <section class="content-svg">
            ...
            <div class="media-1410px-none mobail-media">
                <a href="#" class="effect__a">
                    <div class="effect"><img class="svg__img-1 " src="img/3.png" alt="">
                        <div class="block-svg ">
                ...
                <a href="#" class="effect__a">
                    <div class="effect"><img class="svg__img-1 " src="img/2.png" alt="">
                        <div class="block-svg ">
                ...
                <a href="#" class="effect__a">
                    <div class="effect"><img class="svg__img-1" src="img/4.png" alt="">
                        <div class="block-svg ">
                ...
                <a href="#" class="effect__a">
                    <div class="effect"><img class="svg__img-1 " src="img/5.png" alt="">
                        <div class="block-svg ">
                ...
                <a href="#" class="effect__a">
                    <div class="effect"><img class="svg__img-1 " src="img/1.png" alt="">
                        <div class="block-svg ">
	...
	<div class="card__item">
		...
		<div class="dots">
			...
			<h3 class="item__title"><?php the_sub_field('card__title', 'options') ?></h3>
			<div class="dots__item"></div>
		</div>
